      ...
      'rules' => [
        {
          ...
          'manipulators' => [
            generate_launcher_mode('h', [], [{ 'shell_command' => "open -a 'Hyper.app'" }]),
            generate_launcher_mode('g', [], [{ 'shell_command' => "open -a 'Google Chrome.app'" }]),
            generate_launcher_mode('f', [], [{ 'shell_command' => "open -a 'Firefox.app'" }]),
            generate_launcher_mode('d', [], [{ 'shell_command' => "open -a 'Visual Studio Code.app'" }]),
            generate_launcher_mode('s', [], [{ 'shell_command' => "open -a 'Safari.app'" }]),
            generate_launcher_mode('a', [], [{ 'shell_command' => "open -a 'Obsidian.app'" }]),
